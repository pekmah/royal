        ...
        <form className='h-full w-full gap-4' >
            <div className=' flex gap-4 items-center w-full'>
                ...
                <div className=' flex w-full flex-col gap-2'>
                    ...
                    <input type="text" id='name' placeholder='Enter Your Full Name' className='border outline-none rounded-md border-gray px-4 py-2.5'/>
                </div>
                <div className=' flex w-full flex-col gap-2'>
                    <label htmlFor="email">Email</label>
                    <input type="text" id='email' placeholder='Enter Your Email' className='border outline-none rounded-md border-gray px-4 py-2.5' />
                </div>
            </div>
            <div className=' flex w-full flex-col gap-2 py-4'>
            <label htmlFor="phone">Phone</label>
            <input type="text" id='phone' placeholder='+254 703 567 890' className='border outline-none  rounded-md border-gray px-4 py-2.5' />
            </div>
