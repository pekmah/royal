        ...
        <div className=''>
            ...
            <div className='flex pt-32 pb-10  justify-between px-4'>
                ...
                <h2 className={`${barlowSemi.className} flex-1 text-[20px] py-2`}>
                    ...
                    <span className='text-primary_red'> Story</span>
                </h2>

                <div className='flex-1 w-full '>
                    <p className='text-lightgrey text-sm leading-[24px]'>
                        For many years, Royal Mabati Factory Limited has supported many clients succeed through our
                        roofing
                        solutions and products. We are a multinational company that primarily deals with roofing
                        materials,
                        starting out with a factory in Nairobi since our inception in 2005. Today, we’re one of the
                        leading
                        manufacturers of roofing products with over distribution centers across Kenya and Eastern
                        Africa.
                    </p>

                    <p className='text-lightgrey text-sm pt-6'>
                        The strict implementation of state of the art manufacturing facilities, product testing,
                        organized back
                        office, thorough training, field supervision, research & development allows us to ensure the
                        integrity of
            ...
            <div className='bg-[#181818] w-full h-full'>
                <h2 className={`${barlowSemi.className} flex-1 text-[20px] py-6 text-center`}>
                    ...
                    <span className='text-primary_red'> Milestone</span>
                </h2>
                <div className='flex items-center w-full justify-between'>
                    <div className='text-white px-4'>
                        ...
                        <p className='text-center py-4'>We are a multinational company that primarily deals with roofing
                            materials, starting out with a factory in Nairobi since our inception in 2005.</p>
                    </div>
                ...
                <div className='grid grid-cols-3 px-4 py-12 gap-6'>
                    <div>
                        <div className='flex gap-4 items-center'>
                            ...
                            <h4 className={`${barlowSemi.className} flex-1 text-[20px] py-2`}>
                                ...
                                <span className='text-primary_red'> Mission</span>
                            </h4>
                        </div>
                        <p className='text-white py-2 text-sm leading-[24px]'>We are a multinational company that
                            primarily deals with roofing materials,
                    ...
                    <div>
                        ...
                        <p className='py-2 text-white text-sm leading-[24px]'>To proactively establish ourselves as the
                            benchmark of customer satisfaction.</p>
                    </div>
                    {/* core priciple */}
                    <div>
                        <div className='flex gap-4 items-center'>
                        ...
                        <p className='text-white py-2 text-sm leading-[24px]'>We are customer maniacs! Our sales teams
                            and technical support centers listen
