...
import { FaqItem } from "../../../components/About";

const Page = () => {
  return (
    <div>
      <h3 className={"mt-5 text-center font-barlow text-[30px] font-[600]"}>
        FAQs
      </h3>

      <div className={"flex md:w-10/12 mx-auto py-5"}>
        <div className={"w-1/3 hidden md:flex font-barlow "}>
          <ul className={"flex flex-col gap-y-4"}>
            <li
              className={
                "py-3 border-b border-zinc-200 pr-10 text-black font-[500]"
              }
            >
              Quick Answers
            </li>
