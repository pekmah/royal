    ...
    return (
        <div className=''>
            <div className='flex justify-between w-full'>
                ...
                <Link href={'/account/edit'} className='flex gap-2 md:gap-4 text-primary_red items-center'>
            ...
            <div className="">
                ...
                <div className='flex justify-between w-full items-center pb-4'>
                    ...
                    <Link href={'/account/change-password'}
                          className='border text-sm md:text-base border-primary_red rounded-md  text-primary_red bg-white px-4 max-w-max py-1.5'>
                        Change Password
                    </Link>
                </div>
            </div>
